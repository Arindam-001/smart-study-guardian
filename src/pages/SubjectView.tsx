          ...
          <TabsContent value="assignments">
            <div className="mb-6">
              {isTeacherOrAdmin && !showCreateAssignment && !showTakeAssignment && (
                <Button onClick={() => setShowCreateAssignment(true)} className="bg-edu-primary mb-4">
                  Create New Assignment
                </Button>
              )}
              
              {!isTeacherOrAdmin && !showTakeAssignment && (
                <Button onClick={() => setShowTakeAssignment(true)} className="bg-edu-primary mb-4">
                  Take Sample Assignment
                </Button>
              )}
              ...
              {!showCreateAssignment && !showTakeAssignment && (
                <div className="text-center py-8 border rounded-lg bg-gray-50">
                  ...
                  {isTeacherOrAdmin ? (
                    ...
                    <p className="text-muted-foreground mt-2">Take a sample assignment to see the secure testing environment.</p>
                  )}
                </div>
              )}
            </div>
